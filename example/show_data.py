...
plt.axhline(99.04,color='black',label='dgd')
plt.plot(epoch,dzo_acc_1,color='yellow',label='perturbation=1')
plt.plot(epoch,dzo_acc_5,color='pink',label='perturbation=5')
plt.plot(epoch,dzo_acc_10,color='red',label='perturbation=10')
plt.plot(epoch,dzo_acc_20,color='blue',label='perturbation=20')
plt.plot(epoch,dzo_acc_40,color='green',label='perturbation=40')
plt.plot(epoch,dzo_acc_f,color='orange',label='perturbation=40')
plt.legend()  #显示上面的label
plt.xlabel('epochs') #x_label
plt.ylabel('train_accuracy')#y_label
plt.ylim(90,100)
plt.savefig("/home/qyq/bfl/results/accuracy.png")
...
plt.plot(epoch,dzo_loss_f,color='orange',label='perturbation=forward')
plt.legend()  #显示上面的label
plt.xlabel('epochs') #x_label
